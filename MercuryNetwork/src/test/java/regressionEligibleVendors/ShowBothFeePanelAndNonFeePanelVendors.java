...
/**
 * <h1>Eligible Vendors - Show Both Fee Panel And Non Fee Panel Vendors</h1>
 * 
 * <p>.
 *
...
public class ShowBothFeePanelAndNonFeePanelVendors extends TestSetup {
	...
	public void acceptOnlyFromFeePanel() throws Exception{
		...
		perform.apiPlaceOrderFromSecure(driver, "VendorOrderCapacity2", "T3sting1", "PlaceMNOrder-ShowBothFeePanelAndNonFeePanelVendors");
		...
		// Place order through API
		perform.apiPlaceOrderFromSecure(driver, "VendorOrderCapacity1", "T3sting1", "PlaceMNOrder-ShowBothFeePanelAndNonFeePanelVendors");
