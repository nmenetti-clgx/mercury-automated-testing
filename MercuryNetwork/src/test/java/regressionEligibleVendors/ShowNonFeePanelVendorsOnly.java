...
/**
 * <h1>Eligible Vendors - Show Non Fee Panel Vendors Only</h1>
 * 
 * <p>.
 *
...
public class ShowNonFeePanelVendorsOnly extends TestSetup {
	...
	public void acceptOnlyFromFeePanel() throws Exception{
		...
		perform.apiPlaceOrderFromSecure(driver, "VendorOrderCapacity2", "T3sting1", "PlaceMNOrder-ShowNonFeePanelVendorsOnly");
		...
		// Place order through API
		perform.apiPlaceOrderFromSecure(driver, "VendorOrderCapacity1", "T3sting1", "PlaceMNOrder-ShowNonFeePanelVendorsOnly");
